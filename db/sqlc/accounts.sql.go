...
INSERT INTO accounts (
    ...
    $1, $2, $3, $4, $5, $6, $7
) RETURNING id, title, type, description, value, date, created_at, user_id, category_id
`
...
SELECT id, title, type, description, value, date, created_at, user_id, category_id
FROM accounts
WHERE id = $1 LIMIT 1
`
